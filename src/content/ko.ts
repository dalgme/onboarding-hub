    ...
    process: {
      ...
      stages: [
        ...
        },
        {
          ...
          who: "client",
          where: "단계 탭에서 모니터링",
          body: "의뢰인이 포털 안내를 따라 GitHub 조직·Vercel 팀·Supabase 조직(AI 의뢰면 Anthropic까지)을 만들고 나를 초대한다. 완료 요청이 오면 「지금 확인」 또는 눈으로 확인 후 「확인 완료로」. 해당 없는 단계는 「건너뜀으로」. 막힘 표시가 뜨면 연락하거나 화면공유를 잡는다.",
        },
        {
          title: "개발 진행",
          who: "me",
