...
export const ko = {
  ...
  portal: {
    ...
    helpSections: [
      ...
      {
        title: "로그인은 어떻게 하나요?",
        body: "가입도 비밀번호도 없습니다. 로그인 화면에 등록된 이메일 주소를 입력하면 메일로 로그인 링크가 옵니다. 링크는 24시간 동안 유효하며, 만료되면 같은 방법으로 다시 받으면 됩니다. 제작자가 로그인 링크를 카톡 등으로 직접 보내드리는 경우도 있습니다.",
      },
      {
        title: "전체 진행 순서",
  ...
  admin: {
    ...
    guide: {
      ...
      settings: [
        ...
        "「로그인 링크 만들기」: 메일이 늦거나 스팸함에 빠질 때, 로그인 링크를 직접 만들어 카톡 등으로 전달한다.",
      ],
      close: [
    ...
    process: {
      ...
      stages: [
        ...
        },
        {
          ...
          who: "me",
          where: "설정 탭",
          body: "포털 주소를 복사해 보내거나, 「로그인 링크 만들기」로 1회용 로그인 링크를 만들어 카톡으로 전달한다.",
        },
        {
          title: "계정 3개 연결",
          who: "client",
    ...
    magicLink: {
      title: "로그인 링크 만들기",
      help: "로그인 메일이 늦거나 스팸함에 빠질 때, 여기서 로그인 링크를 직접 만들어 카톡 등으로 전달한다. 링크는 24시간 유효하고 1회만 쓸 수 있으며, 클릭하면 곧바로 그 이메일 계정으로 로그인된다.",
      warning:
