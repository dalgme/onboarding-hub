...
export const ko = {
  ...
  portal: {
    ...
    helpSections: [
      ...
      {
        title: "전체 진행 순서",
        body: "① 계정 연결(GitHub·Vercel·Supabase, 필요 시 AI 계정 등 — 서비스의 소유권을 의뢰인 명의로 두기 위한 준비) → ② 작업 범위 확인 → ③ 개발 진행(제작자) → ④ 도메인 연결 → ⑤ 전달 및 인수인계. 의뢰인께서 직접 하시는 일은 ①·②·④뿐이고, 나머지는 제작자가 진행합니다.",
      },
      {
      ...
      {
        title: "앱처럼 설치하기",
        body: "이 페이지는 홈 화면에 앱으로 추가할 수 있습니다. 안드로이드(크롬): 브라우저 메뉴(⋮) → 「홈 화면에 추가」 또는 「앱 설치」. 아이폰(사파리): 하단 공유 버튼 → 「홈 화면에 추가」. 추가하면 아이콘 한 번으로 바로 들어올 수 있습니다.",
      },
      {
        title: "하다가 막히면?",
  ...
  stepDetail: {
    ...
    // 포털 홈 카드 전용 — 단계 화면의 버튼·역할 안내를 가리키는 문장은 홈에서 말이 되지 않는다
    verifyCodeHome: {
      check_invite:
        "초대 화면에 제 이메일이 보이는지만 한 번 확인해 주세요. 아래 버튼을 누르면 복사할 이메일과 초대 화면 링크가 함께 나옵니다.",
  ...
  assist: {
    ...
    title: "온보딩 도우미",
    greeting:
      "안녕하세요! 지금 이 단계에서 막히는 부분이 있으면 편하게 물어보세요. 화면 어디를 눌러야 하는지 알려드릴게요.",
    placeholder: "예: 초대 화면이 어디에 있나요?",
    send: "보내기",
    thinking: "확인하는 중…",
    close: "닫기",
    privacy:
      "이 대화는 저장되지 않습니다. 비밀번호·인증번호는 적지 말아 주세요.",
    suggestions: [
      "지금 무엇부터 하면 되나요?",
      "어느 메뉴를 눌러야 하는지 모르겠어요",
      "초대는 어떻게 하나요?",
    ],
    unavailable:
      "도우미가 아직 준비되지 않았습니다. 화면 아래 「막혔어요」를 누르시면 제작자가 직접 도와드립니다.",
    failed:
      "도우미 연결에 문제가 있어 답을 드리지 못했습니다. 잠시 후 다시 시도하시거나, 화면 아래 「막혔어요」를 눌러 주세요.",
    refused:
      "그 질문에는 답변드리기 어렵습니다. 화면 아래 「막혔어요」를 눌러 주시면 제작자가 직접 도와드립니다.",
    empty: "답변을 만들지 못했습니다. 다시 한번 여쭤봐 주세요.",
    truncated:
      "답이 길어져 여기까지만 보여드렸습니다. 한 가지만 좁혀서 다시 물어봐 주시거나, 화면 아래 「막혔어요」를 눌러 주세요.",
    tooMany:
      "질문이 너무 빠르게 이어졌습니다. 잠시 후 다시 물어봐 주세요. 급하시면 화면 아래 「막혔어요」를 눌러 주세요.",
    closed:
      "종료된 프로젝트라 도우미를 사용할 수 없습니다. 문의는 담당자에게 직접 연락해 주세요.",
  },

  errorPage: {
    title: "잠시 문제가 생겼습니다",
    description:
      "제작자에게 자동으로 전달되었습니다. 의뢰인 잘못이 아니니 걱정하지 마세요. 잠시 후 다시 시도해 주세요.",
    retry: "다시 시도",
    home: "처음 화면으로",
  },
  ...
  admin: {
    ...
    health: {
      title: "검증 설정 점검",
      description:
        "의뢰인이 「연결 확인하기」를 누르면 아래 토큰으로 각 서비스에 물어본다. 하나라도 빨간색이면 자동 확인이 되지 않고, 의뢰인 화면에는 「제작자 확인 중」이 뜬다. 「이메일 불일치」는 허브 관리자 이메일과 그 서비스 계정 이메일이 달라 의뢰인의 초대를 수락할 수 없다는 뜻이다. 접속 정보를 보내기 전에 전부 초록색인지 본다.",
      checking: "토큰 상태 확인 중…",
      statuses: {
        ok: "정상",
        missing: "미설정",
    ...
    guide: {
      steps: [
        ...
        "GitHub·Vercel·Supabase 단계는 사람이 확인 버튼을 누르지 않는다. 의뢰인이 「완료했습니다」를 누르는 순간 서버가 각 서비스에 물어보고, 확인되면 그 자리에서 「확인 완료」가 된다. 「아직 확인 안 됨 · 초대 수락 전」이면 내가 초대를 수락하는 것이 다음 할 일이고, 수락 뒤 이 화면이나 포털이 열릴 때 자동으로 다시 확인된다. 「지금 확인」은 기다리기 싫을 때 누르는 비상 버튼이다. 「확인 오류」는 의뢰인 문제가 아니라 내 토큰 문제 — 대시보드 최상단 「검증 설정 점검」을 본다.",
      ...
      settings: [
        ...
        "「포털 접근 이메일」: 여기 등록된 이메일만 의뢰인 포털에 로그인할 수 있다. 담당자가 여럿이면 추가한다. 각 이메일 아래에 마지막 접속·비밀번호 상태가 표시된다 — 리마인드가 필요한지 여기서 판단한다.",
    ...
    process: {
      ...
      stages: [
        ...
        },
        {
          ...
          who: "client",
          where: "단계 탭에서 모니터링",
          body: "의뢰인이 포털 안내를 따라 GitHub 조직·Vercel 팀·Supabase 조직(AI 의뢰면 Anthropic까지)을 만들고 나를 초대한다. GitHub·Vercel·Supabase는 완료 요청과 동시에 자동 확인되고, 「초대 수락 전」이면 내가 수락만 하면 다음 방문 때 자동으로 완료된다. Claude·범위 같은 수동 단계만 눈으로 확인 후 「확인 완료로」. 해당 없는 단계는 「건너뜀으로」. 막힘 표시가 뜨면 연락하거나 화면공유를 잡는다.",
        },
        {
          title: "개발 진행",
          who: "me",
    ...
    form: {
      ...
      clientEmail: "의뢰인 이메일",
      clientEmailHelp:
        "이 이메일이 포털 로그인 계정이 됩니다. 생성 후 설정 탭에서 비밀번호를 발급해 카톡으로 전달하세요.",
      supportTier: "지원 등급",
      status: "프로젝트 상태",
      githubOrg: "GitHub 조직",
      vercelTeam: "Vercel 팀",
    ...
    password: {
      ...
      kakaoMessage: (params: {
        ...
        `브라우저 메뉴의 「홈 화면에 추가」를 누르시면 앱처럼 설치되어 다음부터 아이콘 한 번으로 들어오실 수 있습니다.`,
    ...
    access: {
      ...
      neverSeen: "접속 전",
      lastLogin: "마지막 로그인",
      passwordTemp: "임시 비밀번호 (아직 변경 전)",
      passwordSet: "비밀번호 변경 완료",
      noAccount: "계정 미생성 (비밀번호 발급 전)",
      activityTitle: "활동 기록",
      activityHelp: "의뢰인 포털의 작업기록과 같은 내용 — 단계 진행과 코멘트가 시간순으로 쌓인다.",
    },
